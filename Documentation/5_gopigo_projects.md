...
We have generated  the python file "Follow_the_route.py" that reads input data from route.yaml file. The YAML file has three lines. It means that there are three goals. Look on the first line:
...
- Specify a "route.yaml" file with the points to follow and take photo:
    ...
    - {filename: 'picture1.png', position: { x: 0.355, y: -0.2}, quaternion: {r1: 0, r2: 0, r3: -0.628, r4: 0.778}}
    - {filename: 'picture2.png', position: { x: 2.843, y: -1.743}, quaternion: {r1: 0, r2: 0, r3: 0.936, r4: 0.353}}
    - {filename: 'picture3.png', position: { x: 1.401, y: 2.913}, quaternion: {r1: 0, r2: 0, r3: 0.904, r4: -0.427}}
